...
public class DateTimePickDialogUtil implements OnDateChangedListener,
    ...
    public AlertDialog dateTimePicKDialog(final TextView inputDate) {
        RelativeLayout dateTimeLayout = (RelativeLayout) activity
                .getLayoutInflater().inflate(R.layout.dialog_lingfu_datatime, null);
                ...
                .setPositiveButton("设置", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        try {
                            ...
                            String lunar = bazi.getYearGanZhi(min);
                            String lunarY = lunar.split(",")[0];
                            String lunarM = lunar.split(",")[1];
                            String lunarD = lunar.split(",")[2];
                            String lunarS = lunar.split(",")[3];
