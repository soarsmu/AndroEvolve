...
public class YDateDialog {
    ...
    public YDateDialog(Activity activity) {
        ...
        this.activity.setTheme(android.R.style.Theme_Holo_Light_NoActionBar);
    }
    ...
    public void show(final DataListener dataListener) {
        ...
        if (initDateTime != null) {
            try {
                ...
                Log.e("YDateDialog", e.getMessage());
            }
        }
        if (initDate != null) {
        ...
        //初始化弹窗时间
        ad = new AlertDialog.Builder(activity).setTitle(sdf.format(calendar.getTime())).setView(dateTimeLayout).setPositiveButton("设置", new OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                if (dataListener != null) {
                    ...
                    dataListener.getDataTime(dateTime, calendar, calendar.getTime(), yyyy, MM, dd, HH, mm);
                }
            }
    ...
    public static void TEST(Activity activity) {
        ...
        yDateDialog.show(new DataListener() {
            @Override
            public void getDataTime(String format, Calendar calendar, Date date, String yyyy, String MM, String dd, String HH, String mm) {
